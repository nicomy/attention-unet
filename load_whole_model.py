...
custom_objects = {
    ...
    "DiceLoss": dice_loss , #losses.DiceLoss,
    "CategoricalFocalLoss":focal_loss, #losses.CategoricalFocalLoss,
    "IOUScore": sm.metrics.IOUScore(threshold=0.5) , #metrics.IOUScore,
    "FScore": sm.metrics.FScore(threshold=0.5) , #metrics.FScore,
}
import tensorflow as tf
model_arc_normal = tf.keras.models.load_model(
    path_model+prefix+train_normal+".h5",
